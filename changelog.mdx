...
You can now tell Deliverable which CSV column holds the emails. If you don't send `emailColumn`, the API still looks for a column named `Email`, just like before. Existing integrations keep working.
